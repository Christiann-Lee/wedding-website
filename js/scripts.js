$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Sahil and Ridmi's Wedding",

            // Event start date
            start: new Date('Nov 27, 2023 10:00'),
...
// Google map
function initMap() {
    var location = {lat: 6.9289675556020525, lng: 79.8444564407367};
...
function initBBSRMap() {
    var la_fiesta = {lat: 6.9289675556020525, lng: 79.8444564407367};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
